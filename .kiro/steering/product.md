...
**Shiro** is a Flutter-based mental health support application that provides comprehensive wellness tools through an AI-powered assistant.

## Core Features

- **AI Chatbot (Shiro)**: Empathetic mental health assistant powered by OpenRouter AI (Mistral models)
