    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Column(
            children: [
              _durationButton("1 Minute", const Duration(minutes: 1), Icons.looks_one),
              const SizedBox(height: 12),
              _durationButton("3 Minutes", const Duration(minutes: 3), Icons.looks_3),
              const SizedBox(height: 12),
              _durationButton("5 Minutes", const Duration(minutes: 5), Icons.looks_5),
            ],
          ),
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Phase ${_currentPhaseIndex + 1} of 4',
                style: TextStyle(
                  fontSize: 13,
                  color: _primaryColor,
                  fontWeight: FontWeight.w500,
        ...
        children: [
          if (_hasStarted) ...[
            ElevatedButton.icon(
              ...
              label: const Text("Stop Session", style: TextStyle(fontSize: 14)),
              style: ElevatedButton.styleFrom(
